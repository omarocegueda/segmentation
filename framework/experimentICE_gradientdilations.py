...
results_dir = '/home/dalmau/opt/segmentation/framework/experimentICE_gradientdilations_output/example2_30wCoronal/dil4/'
atlas_label = '28w'
nscaledilations = 4  # {4,5,6,7,8}   <-- number of consecutive gradient scale dilations
