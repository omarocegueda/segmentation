...
# Read subject files
t2CurrentSubjectName = "/home/dalmau/opt/imagenes/data_NeoBrainS12/trainingDataNeoBrainS12/30wCoronal/example2/T2_1-1.nii.gz"
t1CurrentSubjectName = "/home/dalmau/opt/imagenes/data_NeoBrainS12/trainingDataNeoBrainS12/30wCoronal/example2/T1_1-2.nii.gz"
GTName = "/home/dalmau/opt/imagenes/data_NeoBrainS12/trainingDataNeoBrainS12/30wCoronal/example2/manualSegm.nii.gz"
...
# Read priors files
AT1Name = "/home/dalmau/opt/imagenes/data_NeoBrainS12/trainingDataNeoBrainS12/30wCoronal/example2/A28w_T1.nii.gz"
AT2Name = "/home/dalmau/opt/imagenes/data_NeoBrainS12/trainingDataNeoBrainS12/30wCoronal/example2/A28w_T2.nii.gz"
AMaskName = "/home/dalmau/opt/imagenes/data_NeoBrainS12/trainingDataNeoBrainS12/30wCoronal/example2/A28w_Mask.nii.gz"
ABSName = "/home/dalmau/opt/imagenes/data_NeoBrainS12/trainingDataNeoBrainS12/30wCoronal/example2/A28w_BS.nii.gz"
ACeName = "/home/dalmau/opt/imagenes/data_NeoBrainS12/trainingDataNeoBrainS12/30wCoronal/example2/A28w_Ce.nii.gz"
ACoName = "/home/dalmau/opt/imagenes/data_NeoBrainS12/trainingDataNeoBrainS12/30wCoronal/example2/A28w_Co.nii.gz"
ACSFName = "/home/dalmau/opt/imagenes/data_NeoBrainS12/trainingDataNeoBrainS12/30wCoronal/example2/A28w_CSF.nii.gz"
ADGMName = "/home/dalmau/opt/imagenes/data_NeoBrainS12/trainingDataNeoBrainS12/30wCoronal/example2/A28w_DGM.nii.gz"
AWMName = "/home/dalmau/opt/imagenes/data_NeoBrainS12/trainingDataNeoBrainS12/30wCoronal/example2/A28w_WM.nii.gz"
...
# 2 - Intracraneal Cavity Extraction
...
Im.save('T2_IC.png')
Im = Image.fromarray(np.uint8(t2CurrentSubject_data[:,:,nSlice+10]))
Im.save('T2_IC_p10.png')
Im = Image.fromarray(np.uint8(t2CurrentSubject_data[:,:,nSlice-10]))
Im.save('T2_IC_m10.png')
...
Im.save('GradientMorp_NoNorm.png')
del dilationOT2
del erosionOT2
gradientOT2 = NormalizeIntensity(gradientOT2,255.0)
Im = Image.fromarray(np.uint8(gradientOT2[:,:,nSlice]))
Im.save('GradientMorp_Norm.png')
...
Im.save('ICEMask.png')
Im = Image.fromarray(np.uint8(ICEMask[:,:,nSlice+10]*127))
Im.save('ICEMask_p10.png')
Im = Image.fromarray(np.uint8(ICEMask[:,:,nSlice-10]*127))
Im.save('ICEMask_m10.png')
Im = Image.fromarray(np.uint8(t1CurrentSubject_data[:,:,nSlice]))
Im.save('t1CS.png')
Im = Image.fromarray(np.uint8(t1CurrentSubject_data[:,:,nSlice+10]))
Im.save('t1CS_p10.png')
Im = Image.fromarray(np.uint8(t1CurrentSubject_data[:,:,nSlice-10]))
Im.save('t1CS_m10.png')
Im = Image.fromarray(np.uint8(t2CurrentSubject_data[:,:,nSlice]))
Im.save('t2CS.png')
Im = Image.fromarray(np.uint8(t2CurrentSubject_data[:,:,nSlice+10]))
Im.save('t2CS_p10.png')
Im = Image.fromarray(np.uint8(t2CurrentSubject_data[:,:,nSlice-10]))
Im.save('t2CS_m10.png')
...
# 3 - Detection of subcortical Grey Matter
...
#Im.save('lsClosingT2.png')
#Im = Image.fromarray(np.uint8(lsClosingT2[:,:,nSlice+10]))
#Im.save('lsClosingT2_p10.png')
#Im = Image.fromarray(np.uint8(lsClosingT2[:,:,nSlice-10]))
#Im.save('lsClosingT2_m10.png')
...
Im.save('sumClosingT2.png')
Im = Image.fromarray(np.uint8(NormalizeIntensity(sumClosingT2[:,:,nSlice+10],255.0)))
Im.save('sumClosingT2_p10.png')
Im = Image.fromarray(np.uint8(NormalizeIntensity(sumClosingT2[:,:,nSlice-10],255.0)))
Im.save('sumClosingT2_m10.png')
...
#Im.save('SGMMask.png')
#Im = Image.fromarray(np.uint8(SGMMask[:,:,nSlice+10]*85))
#Im.save('SGMMask_p10.png')
#Im = Image.fromarray(np.uint8(SGMMask[:,:,nSlice-10]*85))
#Im.save('SGMMask_m10.png')





# 3 - Detection of GM, WM and CSF
...
#print "Total time (K-means): {} seconds.".format(time.time() - start_time)
...
#Im.save('GMMapOpening.png')

#   Get largest connected component of WM resulted from kmeans and
...
Im = Image.fromarray(np.uint8(GMMap[:,:,nSlice]))
Im.save('GMMap.png')
Im = Image.fromarray(np.uint8(GMMap[:,:,nSlice+12]))
Im.save('GMMap_p12.png')
Im = Image.fromarray(np.uint8(GMMap[:,:,nSlice-12]))
Im.save('GMMap_m10.png')
...
Im.save('SegMap.png')
Im = Image.fromarray(np.uint8(SegMap[:,:,nSlice+10]))
Im.save('SegMap_p10.png')
Im = Image.fromarray(np.uint8(SegMap[:,:,nSlice-10]))
Im.save('SegMap_m10.png')
...
Im.save('SegMap1.png')
Im = Image.fromarray(np.uint8(SegMap[:,:,nSlice+10]))
Im.save('SegMap1_p10.png')
Im = Image.fromarray(np.uint8(SegMap[:,:,nSlice-10]))
Im.save('SegMap1_m10.png')
 ...
 for j in xrange(20,dim2-20):
  for k in xrange(0,GT_data.shape[2]):
   if GT_data[i,j,k] <> 6 and GT_data[i,j,k] <> 5 and GT_data[i,j,k]<>4 :
     ...
     if SegMap[i,j,k1] == 85 :
        denSMGM = denSMGM + 1
     elif SegMap[i,j,k1] == 255 :
        denSMCSF = denSMCSF + 1
     else :
        if SegMap[i,j,k1]== 190 :
           denSMWM = denSMWM + 1
     if GT_data[i,j,k] == 1 or GT_data[i,j,k] == 2 : #or GT_data[i,j,k] == 5 or GT_data[i,j,k] == 6 :
        denGTGM = denGTGM + 1
        if SegMap[i,j,k1] == 85 :
           numeGM = numeGM + 1
     elif GT_data[i,j,k] == 3 : #or GT_data[i,j,k] == 4 :
        denGTWM = denGTWM + 1
        if SegMap[i,j,k1]== 190 :
           numeWM = numeWM + 1
     else :
