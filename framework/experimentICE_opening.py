...
results_dir = '/home/dalmau/opt/segmentation/framework/experimentICE_opening_output/example2_30wCoronal/se_diam7/'
atlas_label = '28w'
se_diam = 7  # {7,9,11,13,15}   <-- structuring element diameter for morphological opening
...
struct_elem = ball(int(se_diam/2.0)) # <-- should have 9 voxel units of diameter
